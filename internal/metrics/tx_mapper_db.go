...
func (tm *TxMapperDB) AddBlock(
	...
	identityPreimageToDecKeyAndMsg := make(map[string]*data.QueryDecryptionKeysAndMessageRow)
	...
	for index, txSubEvent := range txSubEvents {
		...
		log.Debug().Int64("txPointer", dkam.TxPointer.Int64).
			Int64("keyIndex", dkam.KeyIndex).
			Int64("eon", dkam.Eon.Int64).
